Certainly! Below are the rewritten R functions that use SQLite (`sqlite3`) instead of PostgreSQL. These functions perform the same operations as before but are adapted to work with SQLite databases.
